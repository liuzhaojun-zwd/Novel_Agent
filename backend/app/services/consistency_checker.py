...
_EXCLUDE = {
    ...
    "慢慢","已经","曾经","从未","没有","也许","大概","反正",
    "难道","究竟","到底","是否","能否","不如","无论","不管",
    "只要","除非","如果","要是","假如","假使","纵使","即使","哪怕",
    "虽然","虽说","固然","尽管","却","则","于是","因此","因而",
    "以致","既然","就算","纵然","所谓","那样","这样","这种","那种",
    "各类","各种","有关","相关","无关","关于","对于",
    "只见","就听","只听","但见","忽听","忽见","那封","几名",
    # 补充：小说高频地点/场景词（这些2字组合极易误判为人物名）
    "城门","山谷","楼阁","殿堂","院落","宫殿","城池","小镇","村落",
    "城墙","城楼","山路","河边","湖面","海岸","山巅","山顶","山下",
    "门外","屋内","房中","室内","厅堂","书房","卧室","厨房","花园",
    "森林","沙漠","草原","荒野","沼泽","洞穴","地道","水底","海底",
    "书房","客栈","酒楼","茶馆","集市","街道","战场","营地","军营",
    # 补充：时间/天气/自然现象（也是小说高频误判词）
    "风中","雨中","雪中","雾中","夜色","月光","星光","日光","火光",
    "闪电","雷声","暴风","狂风","微雨","暴雨","细雨","晨雾","暮色",
    # 补充：动作/状态描写（极易误判）
    "快步","缓步","疾步","急步","踱步","疾行","缓行","急行","独行",
    "独行","慢走","快走","疾走","急走","缓走","并肩","携手","并肩",
    "前行","后退","上升","下降","横跨","穿越","穿梭","往返","奔赴",
    # 补充：情绪/心理描写
    "愁绪","喜色","怒色","忧色","惊色","惧色","惶恐","惊喜","诧异",
